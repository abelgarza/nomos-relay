...
PROXY_PORT=11435
PI_BIN="/home/abelg/.nvm/versions/node/v24.14.1/bin/pi"
...
if ! lsof -i :$PROXY_PORT > /dev/null 2>&1; then
    ...
    # Si nosotros lo arrancamos, nosotros lo cerramos al terminar pi
    trap cleanup EXIT
else
    echo "[Nomos] El proxy ya estaba corriendo."
fi

# 2. Ejecutar Pi con los argumentos pasados
$PI_BIN "$@"
